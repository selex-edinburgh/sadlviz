 ...
 * </p>
 * <ul>
 *   <li>{@link sadl.impl.TransportImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link sadl.impl.TransportImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransportImpl extends PackageableElementImpl implements Transport {
  ...
  protected EClass eStaticClass() {
    return SadlPackage.Literals.TRANSPORT;
  }
  ...
  public void setDescription(String newDescription) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SadlPackage.TRANSPORT__DESCRIPTION, oldDescription, description));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case SadlPackage.TRANSPORT__DESCRIPTION:
