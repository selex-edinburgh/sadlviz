...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>sadl</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SadlExample {
  /**
   * <!-- begin-user-doc -->
  ...
  public static void main(String[] args) {
    ...
    if (args.length == 0) {
      ...
      try {
        Resource resource = resourceSet.createResource(URI.createURI("http:///My.sadl"));
        Model root = SadlFactory.eINSTANCE.createModel();
