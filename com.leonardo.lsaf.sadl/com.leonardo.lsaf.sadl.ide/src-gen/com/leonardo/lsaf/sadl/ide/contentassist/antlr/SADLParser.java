...
public class SADLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SADLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInstanceAccess().getAlternatives_3_1(), "rule__Instance__Alternatives_3_1");
			builder.put(grammarAccess.getInstanceAccess().getAlternatives_3_1_2_2(), "rule__Instance__Alternatives_3_1_2_2");
			...
			builder.put(grammarAccess.getInstanceAccess().getGroup_3(), "rule__Instance__Group_3__0");
			builder.put(grammarAccess.getInstanceAccess().getGroup_3_1_2(), "rule__Instance__Group_3_1_2__0");
			...
			builder.put(grammarAccess.getApplicationAccess().getContainersAssignment_3(), "rule__Application__ContainersAssignment_3");
			...
			builder.put(grammarAccess.getContainerAccess().getInstancesAssignment_3_0(), "rule__Container__InstancesAssignment_3_0");
			builder.put(grammarAccess.getContainerAccess().getConnectionsAssignment_3_1(), "rule__Container__ConnectionsAssignment_3_1");
			builder.put(grammarAccess.getContainerAccess().getChildrenAssignment_3_2(), "rule__Container__ChildrenAssignment_3_2");
			builder.put(grammarAccess.getInstanceAccess().getTypeAssignment_1(), "rule__Instance__TypeAssignment_1");
			builder.put(grammarAccess.getInstanceAccess().getNameAssignment_2(), "rule__Instance__NameAssignment_2");
			builder.put(grammarAccess.getInstanceAccess().getUnboundedAssignment_3_1_0(), "rule__Instance__UnboundedAssignment_3_1_0");
			builder.put(grammarAccess.getInstanceAccess().getLowerBoundAssignment_3_1_1(), "rule__Instance__LowerBoundAssignment_3_1_1");
			builder.put(grammarAccess.getInstanceAccess().getLowerBoundAssignment_3_1_2_0(), "rule__Instance__LowerBoundAssignment_3_1_2_0");
			builder.put(grammarAccess.getInstanceAccess().getUnboundedAssignment_3_1_2_2_0(), "rule__Instance__UnboundedAssignment_3_1_2_2_0");
			builder.put(grammarAccess.getInstanceAccess().getUpperBoundAssignment_3_1_2_2_1(), "rule__Instance__UpperBoundAssignment_3_1_2_2_1");
			builder.put(grammarAccess.getInstanceAccess().getDescriptionAssignment_4(), "rule__Instance__DescriptionAssignment_4");
