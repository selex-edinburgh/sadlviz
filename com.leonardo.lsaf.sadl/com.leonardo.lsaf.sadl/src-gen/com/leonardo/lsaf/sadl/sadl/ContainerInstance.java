 ...
 * </ul>
 *
 * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getContainerInstance()
 * @model
 * @generated
 */
public interface ContainerInstance extends EObject
{
   ...
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getContainerInstance_Type()
   * @model
   * @generated
   */
  Container getType();
   ...
   * @see #setName(String)
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getContainerInstance_Name()
   * @model
   * @generated
   */
  String getName();
   ...
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getContainerInstance_Description()
   * @model
   * @generated
   */
