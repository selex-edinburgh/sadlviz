 ...
 * </ul>
 *
 * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPrimitive()
 * @model
 * @generated
 */
public interface Primitive extends Type
{
   ...
   * @see #setMin(double)
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPrimitive_Min()
   * @model
   * @generated
   */
  double getMin();
   ...
   * @see #setMax(double)
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPrimitive_Max()
   * @model
   * @generated
   */
  double getMax();
   ...
   * @see #setRes(double)
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPrimitive_Res()
   * @model
   * @generated
   */
  double getRes();
