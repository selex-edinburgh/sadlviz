 ...
 * </ul>
 *
 * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getEnumerator()
 * @model
 * @generated
 */
public interface Enumerator extends EObject
{
   ...
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getEnumerator_Deprecated()
   * @model
   * @generated
   */
   ...
   * @see #setName(String)
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getEnumerator_Name()
   * @model
   * @generated
   */
  String getName();
   ...
   * @see #setValue(int)
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getEnumerator_Value()
   * @model
   * @generated
   */
  int getValue();
   ...
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getEnumerator_Description()
   * @model
   * @generated
   */
