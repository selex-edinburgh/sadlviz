 ...
 * </ul>
 *
 * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPlatform()
 * @model
 * @generated
 */
public interface Platform extends PackageableElement
{
   ...
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPlatform_Description()
   * @model
   * @generated
   */
   ...
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPlatform_Processors()
   ...
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPlatform_Links()
   * @model containment="true"
   * @generated
   */
  EList<Link> getLinks();
