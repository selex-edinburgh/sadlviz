 ...
 * </ul>
 *
 * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getProcessor()
 * @model
 * @generated
 */
public interface Processor extends EObject
{
   ...
   * @see #setName(String)
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getProcessor_Name()
   * @model
   * @generated
   */
  String getName();
   ...
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getProcessor_Description()
   * @model
   * @generated
   */
