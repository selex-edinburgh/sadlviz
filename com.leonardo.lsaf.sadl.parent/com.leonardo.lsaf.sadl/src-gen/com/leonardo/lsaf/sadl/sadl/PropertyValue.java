 ...
 * </ul>
 *
 * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPropertyValue()
 * @model
 * @generated
 */
public interface PropertyValue extends EObject
{
   ...
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPropertyValue_Property()
   * @model
   * @generated
   */
   ...
   * @see #setValue(String)
   * @see com.leonardo.lsaf.sadl.sadl.SadlPackage#getPropertyValue_Value()
   * @model
   * @generated
   */
  String getValue();
